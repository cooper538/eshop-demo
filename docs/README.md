...
EShop Demo documentation index.
...
- [Specifications](../specification/) - Phase and task definitions
- [High-Level Specs](../specification/high-level-specs/) - Architecture decision records
