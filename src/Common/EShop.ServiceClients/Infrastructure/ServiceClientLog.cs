...
public static partial class ServiceClientLog
{
    ...
    public static partial void HttpCallStarted(this ILogger logger, string method, string operation);

    [LoggerMessage(Level = LogLevel.Warning, Message = "HTTP {Method} call failed: {Operation} returned {StatusCode}")]
    public static partial void HttpCallFailed(this ILogger logger, string method, string operation, int statusCode);
